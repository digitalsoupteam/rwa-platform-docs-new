...
export function AISearchPanelHeader({ className, ...props }: ComponentProps<'div'>) {
  ...
  return (
    <div
      className={cn(
        'flex items-center gap-2 px-4 py-3 border-b border-fd-border',
        className,
      )}
      {...props}
    >
      <div className="flex-1">
        <p className="text-sm font-semibold text-fd-foreground">AI Chat</p>
      </div>
  ...
  return (
    <>
      ...
      <Presence present={open}>
        <div
          className={cn(
            'fixed bottom-20 end-4 z-30 w-[380px] max-w-[calc(100vw-2rem)] rounded-2xl border border-fd-border bg-fd-card shadow-xl',
            open ? 'animate-fd-dialog-in' : 'animate-fd-dialog-out',
          )}
        >
          <div className="flex flex-col max-h-[500px]">
            <AISearchPanelHeader />
            <AISearchPanelList className="flex-1 min-h-0 overflow-y-auto" />
            <div className="border-t border-fd-border p-3">
              <AISearchInput />
              <div className="flex items-center gap-1.5 mt-1 empty:hidden">
